...
import videoinsights_client.models
from videoinsights_client import rest
from videoinsights_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(videoinsights_client.models, klass)
